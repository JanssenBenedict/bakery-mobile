...
<br>Jawaban:<br>
Deployment proyek Django bakery berhasil di-deploy ke PWS dengan baik, push.yml dimanfaatkan untuk melakukan push ke PWS secara langsung setelah dilakukan push ke repositori GitHub-nya.
